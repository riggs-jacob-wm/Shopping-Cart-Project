    ...
    <div id="info">
        ...
        <div id="content">
            ...
            <div id="main" style="color: #FAF9F8">
                <!-- Main -->
                <img src="http://pngimg.com/upload/fishing_pole_PNG10583.png" style="width: 395px; height: 295px;">
                <h2>Price: $249 .99</h2>
                <form>
                    <form action="pole2.php" method="post">
                        <input type="hidden" name="productname" id="productname" value="Dobyns Champion"><br>
                        Quantity <input type="number" name="productquantity">
                        <input type="hidden" name="productprice" value="249.99"<br>
