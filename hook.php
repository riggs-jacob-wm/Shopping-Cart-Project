    ...
    <div id="info">
        ...
        <div id="content">
            ...
            <div id="main" style="color: #FAF9F8">
                <!-- Main -->
                <img src="https://bagleybait.com/wp-content/uploads/2014/06/SmallFry_0001_SFBB1-BRG.png" style="width: 395px; height: 295px;">
                <h2>Price: $3 .59</h2>
                <form>
                    <form action="hook.php" method="post">
                        <input type="hidden" name="productname" id="productname" value="hook"><br>
                        Quantity <input type="number" name="productquantity">
                        <input type="hidden" name="productprice" value="$3.59"<br>
