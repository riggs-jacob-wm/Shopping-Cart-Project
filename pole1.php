    ...
    <div id="info">
        ...
        <div id="content">
            ...
            <div id="main" style="color: #FAF9F8">
                <!-- Main -->
                <img src="http://pngimg.com/upload/fishing_pole_PNG10597.png" style="width: 395px; height: 295px;">
                <h2>Price: $65 .00</h2>
                <form action="pole1.php" method="post">
                    <input type="hidden" name="productname" id="productname" value="PENN Fierce"><br>
                    Quantity <input type="number" name="productquantity">
                    <input type="hidden" name="productprice" value="65.00"<br>
