    ...
    <div id="info">
        ...
        <div id="content">
            ...
            <div id="main" style="color: #FAF9F8">
                <!-- Main -->
                <img src="http://purefishing.scene7.com/is/image/purefishing/1373574_A_IS?$p-tile-trans$" style="width: 395px; height: 295px;">
                <h2>Price: $129 .99</h2>
                <form>
                    <form action="pole6.php" method="post">
                        <input type="hidden" name="productname" id="productname" value="Abu Garcia"><br>
                        Quantity <input type="number" name="productquantity">
                        <input type="hidden" name="productprice" value="129.99"<br>
