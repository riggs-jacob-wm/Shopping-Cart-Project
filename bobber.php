    ...
    <div id="info">
        ...
        <div id="content">
            ...
            <div id="main" style="color: #FAF9F8">
                <!-- Main -->
                <img src="http://joslinlake.com/images/cover/lakebobber_01.png" style="width: 395px; height: 295px;">
                <h2>Price: $2 .99</h2>
                <form>
                    <form action="bobber.php" method="post">
                        <input type="hidden" name="productname" id="productname" value="bobber"><br>
                        Quantity <input type="number" name="productquantity">
                        <input type="hidden" name="productprice" value="2.99"<br>
