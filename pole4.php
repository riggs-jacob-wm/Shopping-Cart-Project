    ...
    <div id="info">
        ...
        <div id="content">
            ...
            <div id="main" style="color: #FAF9F8">
                <!-- Main -->
                <img src="http://pngimg.com/upload/fishing_pole_PNG10586.png" style="width: 395px; height: 295px;">
                <h2>Price: $114 .99</h2>
                <form>
                    <form action="pole4.php" method="post">
                        <input type="hidden" name="productname" id="productname" value="Okuma Citrix"><br>
                        Quantity <input type="number" name="productquantity">
                        <input type="hidden" name="productprice" value="114.99"<br>
